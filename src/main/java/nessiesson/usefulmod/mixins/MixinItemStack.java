...
public abstract class MixinItemStack {
	...
	private boolean noAttributes(Multimap multimap) {
		return LiteModUsefulMod.Companion.getConfig().showItemAttributes || multimap.isEmpty() || !Minecraft.getMinecraft().gameSettings.advancedItemTooltips;
	}
	...
	private NBTTagList sortEnchantments(ItemStack item) {
		return MixinCode.INSTANCE.sortEnchantments(this.getEnchantmentTagList());
	}
}
